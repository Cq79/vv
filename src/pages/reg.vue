<template>
	<div class="content">
	  ...
	  <ul>
		...
		<elm-input v-model="password"  placeholder="密码" ></elm-input>
	    {{mess}}
	  </ul>
	  <div class="footbox">
	     <elm-button bg-color="#02B6FD" @click="reg" text="注 册" style="margin-top:.23rem">登陆</elm-button>
...
<script>
	...
	export default{
		...
		components:{ElmNav,ElmButton,ElmInput},
		mounted(){},
		updated() {
		...
		methods:{
			reg(){
				this.$axios({
					url:'http://47.116.70.86:3333/api/reg',
					method:'post',
					data:{
